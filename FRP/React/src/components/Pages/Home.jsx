            ...
            <div className='mx-20 my-10 font-serif '>
                <div>
                    <div className="absolute">
                        <div className="bg-white border rounded shadow-md size- lg:size- p-2 lg:p-4 w-[255px] lg:w-[350px] text-center mt-[70px] lg:mt-80 ml-6">
                            <h1 className='bg-blue-600 text-white text-[10px] lg:text-[15px] border rounded text-center w-[100px] mt-3'>Technology</h1>
                            <p className='text-left font-bold text-[15px] lg:text-[20px] mt-3'>The Impact of Technology on <br /> the Workplace: How <br />Technology is Changing</p>
                            <div className='flex space-x-1 mt-3 text-[10px] lg:text-[15px]'>
                    ...
                    <div id='Home' className='mt-20'>
                        ...
                        <h3 className=' font-bold flex justify-between mt-[120px] ml-4'>
                            <p >Latest Post</p>
                        ...
                        <h3 className='border rounded justify-self-center mt-8 w-[150px] text-center justify-center pl-2 pr-2'>View All Post</h3>
                    </div>
                </div>
            </div>
